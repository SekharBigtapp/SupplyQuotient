...
export class AddProductMasterComponent implements OnInit {
  ...
  validation_messages = {
    ...
    ArticleId: [
      {type: 'required', message: "Please Enter Article Id"},
    ],
